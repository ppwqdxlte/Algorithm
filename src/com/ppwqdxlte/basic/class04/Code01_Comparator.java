...
public class Code01_Comparator{
    ...
    // 返回0的时候，认为无所谓谁放前面
    public static class IdIncreaseAgeDecreaseComparator implements Comparator<Student> {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(students, new IdIncreaseAgeDecreaseComparator());
        ...
        studentList.sort(new IdIncreaseAgeDecreaseComparator());
